...
file_path = r"C:\agent_workspace\medpro\source_files\PM_Extract.plsql"
...
# result = api.get_entity(code, entity_type='function', entity_name='Variable_Text_Info', filename=file_path, format="markdown", detail_level="full")
# print(result)


signature = api.get_signature(code, entity_type="function", entity_name='Variable_Text_Info', filename=file_path)
print(signature)

docs = api.get_documentation(code, entity_type="function", entity_name='Variable_Text_Info', filename=file_path)
print(docs)

sc = api.get_source_code(code, entity_type="function", entity_name='Variable_Text_Info', filename=file_path)
print(sc)
